...
// const LearningList = () => {
//   return (
//     <div className="max-w-md mx-auto bg-black p-2 rounded-md shadow-md text-white">
...
//       <h2 className="text-xl md:text-2xl font-bold mt-8 mb-4 text-center">
//         Next Steps
//       </h2>
//       <div className="pl-6 text-center">
//         <p className="mb-2">
...
//         </h3>
//         <img src="/images/cone.png" alt="Cone" className="w-12 h-17" />
//       </div>
//     </div>
//   );
// };
