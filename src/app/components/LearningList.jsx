...
//       <h3
//         className={`text-2xl md:text-3xl font-bold mb-4 text-center ${styles['project-details-title']}`}
//       >
//         Final Thoughts
//       </h3>
//       <h2
//         className={`text-xl md:text-2xl font-bold mb-4 text-center ${styles['project-details-title']}`}
//       >
//         What I Learned
//       </h2>
//       <div
//         className={`pl-6 md:pl-0 text-center md:text-center ${styles['project-details-text']}`}
//       >
...
const LearningList = () => {
  return (
    ...
    >
      ...
      <h2
        className={`text-2xl md:text-2xl mb-4 font-bold text-center ${styles['project-details-title']}`}
      >
        What I Learned
      </h2>
      <div
        className={`pl-6 md:pl-0 text-center md:text-center text-xl md:text-xl ${styles['project-details-text']}`}
      >
        <p className="mb-2">
      ...
      <h2
        className={`text-xl md:text-2xl font-bold mt-8 mb-4 text-center md:text-center ${styles['project-details-title']}`}
      >
        Next Steps
      </h2>
      <div
      ...
      <div className="flex flex-col md:flex-row items-center md:justify-center mt-6">
        <h3
          className={`text-xl md:text-2xl font-bold mb-4 md:mb-0 text-center ${styles['project-details-title']}`}
        >
          Thank you, all feedback welcomed
        </h3>
        <Image
