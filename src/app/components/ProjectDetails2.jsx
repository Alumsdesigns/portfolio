...
//       <div className="bg-[#121212] text-white p-8 rounded-md mx-4 md:mx-auto max-w-md">
//         <div
...
//           Exciting UX Design Project Coming Soon!
//         </h2>
//         <p className="text-lg mt-4 mb-4 text-center">
//           While you're waiting, take a look at our Project Details 1 in
//           Projects. If you have any questions or want to discuss your UX design
//           needs, please don't hesitate to reach out to us.
//         </p>
//       </div>
//     </div>
//   );
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center">
      <div className="relative bg-[#121212] text-white p-8 rounded-md mx-4 md:mx-auto max-w-md">
        ...
        <p className="text-lg mt-4 mb-4 text-center">
          While you're waiting, take a look at my Project Details 1, in
          Projects. <br />
          <br />
